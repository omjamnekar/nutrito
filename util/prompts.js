const initialPrompt = `Collect all data available in the image regarding the product composition and its quantities. Provide the data in JSON format with the following consistent keys. Do not include any extraneous text or explanations, only the JSON formatted data as specified below and dont add json:
...
const ratioPrompt = ` I have data for a product, and I need a nutritional analysis of this data to determine if it is healthy to eat. Provide the data in JSON format with the following consistent keys and dont write anything other then format not even JSON
        this is the format:
     {
      ...
      const healthPrompt = `Collect all data available in the image regarding the product composition and its quantities. Provide the data in JSON format with the following consistent keys and  dont add json:
      ...
      const conclusionPrompt = `Collect all data available in the image regarding the product composition and its quantities. Provide the data in JSON format with the following consistent keys: dont write anything other then format not even JSON 
        this is the format:
    {
...
export {initialPrompt,ratioPrompt,healthPrompt,conclusionPrompt};